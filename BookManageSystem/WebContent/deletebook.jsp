...
<center>
	...
	<div class="container" id="iddelele">
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form action="deletebookServlet" method="post" class="form-horizontal" role="form">
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">请输入编号</label>
						<div class="col-sm-10">
	...
	<div class="container" id="namedelele">
		<div class="row clearfix">
			<div class="col-md-12 column">
				<form action="deletebookServlet" method="post" class="form-horizontal" role="form">
					<div class="form-group">
						 <label for="inputEmail3" class="col-sm-2 control-label">请输入书名</label>
						<div class="col-sm-10">
...
<script src="js/deletebook.js" type="text/javascript" charset="utf-8"></script>
</body>
</html>